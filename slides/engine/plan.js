...
const STYLE_MAP = {
  ...
  stripe: { style_base: "stripe", style_description: "" },
  apple: { style_base: "apple", style_description: "" },
  google: { style_base: "google", style_description: "" },
  mckinsey: { style_base: "mckinsey", style_description: "" },
  notion: { style_base: "notion", style_description: "" },
  figma: { style_base: "figma", style_description: "" },
  canva: { style_base: "canva", style_description: "" },
...
- **テキストに絵文字を入れない**
- **other は最大6項目まで**。元のリストが多い場合は最重要なものだけ選ぶ。項目が少ないほどフォントが大きくなり日本語が正確に描画される
- **各 other 項目は25文字以内**。長い場合は要約・省略する
