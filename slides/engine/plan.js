...
const STYLE_MAP = {
  ...
  yellow: {
    style_base: "yellow",
    style_description: "Bold yellow and dark gray angular business presentation. BACKGROUND: pure white (#FFFFFF). CORE PALETTE: vivid yellow #FFB300, dark charcoal #404040, white #FFFFFF, light gray #F0F0F0. ANGULAR SHAPES: sharp diagonal/parallelogram yellow shapes in slide corners — typically top-left and bottom-right as geometric accent blocks; NO rounded corners on decorative shapes. HEADER BAR: yellow horizontal bar at top with dark charcoal bold title text left-aligned; yellow bar may have angled right edge cut diagonally. TYPOGRAPHY: title large bold dark charcoal #404040 (or white if on yellow background); body small dark gray #555555; accent numbers and labels in yellow #FFB300. CARDS: white cards with yellow left-border accent (4-6px) or yellow top-bar; subtle gray border. ICONS: simple flat line icons in yellow or dark gray; placed in yellow circles or standalone. CHARTS: horizontal bar charts in yellow (#FFB300) and dark gray (#404040); progress bars yellow on gray track; pie/donut charts in yellow and charcoal. NUMBER BADGES: bold yellow background with dark number text; or yellow outlined circles. LAYOUT: clean grid, structured columns, data-focused, left-aligned headlines. NEVER use emoji. Flat line-art icons only.",
  },
  teal: {
    style_base: "teal",
