...
const STYLE_MAP = {
  manus: {
    style_base: "stripe",
    style_description: "Light blue and navy business style. BACKGROUND: subtle gradient #EEF4FF to #FFFFFF. PALETTE: navy #0F2C6E, bright blue #2563EB, light blue #BFDBFE. TYPOGRAPHY: H1 extra-bold navy left-aligned; H2 bright blue; body dark gray #374151. CARDS: light blue rounded rectangles (8-12px radius), no shadows. LAYOUT: 30%+ whitespace, strict grid, left-aligned. Flat line-art icons. No emoji.",
  },
  yellow: {
    style_base: "yellow",
    style_description: "Yellow and dark gray angular business style. BACKGROUND: white #FFFFFF. PALETTE: vivid yellow #FFB300, charcoal #404040, light gray #F0F0F0. HEADER: yellow horizontal bar with charcoal bold title left-aligned. CARDS: white with yellow left-border accent (4-6px). TYPOGRAPHY: bold charcoal title, dark gray body, yellow accents. LAYOUT: clean grid, data-focused. Flat line-art icons. No emoji.",
  },
  teal: {
    style_base: "teal",
    style_description: "Teal and orange business style. BACKGROUND: white #FFFFFF. PALETTE: teal #1BADA6, orange #F5A623, dark gray #333333. HEADER: solid teal bar at top with white bold title left-aligned. CARDS: white with teal top-accent bar (4-6px). TYPOGRAPHY: white on teal header, dark gray body, orange accents. LAYOUT: clean grid, generous whitespace. Flat line-art icons. No emoji.",
  },
  premium: {
    style_base: "premium",
    style_description: "Premium luxury seminar style. BACKGROUND: deep navy #0D1B3E. PALETTE: deep navy #0D1B3E, rich gold #C9A842, white #FFFFFF, silver #C0C0C0. TYPOGRAPHY: H1 extra-bold white; H2 gold; body white or silver; key numbers oversized bold gold. CARDS: dark navy panels #0F2040 with gold top-bar or border (6px radius), no shadows. DIVIDERS: thin gold horizontal lines. LAYOUT: left-aligned, 25%+ whitespace. Flat gold line-art icons. No emoji.",
  },
  corporate: {
    style_base: "corporate",
    style_description: "Japanese B2B corporate style. BACKGROUND: white #FFFFFF. PALETTE: white, teal-green #3DBFA0, purple-blue #6B5CE7, dark navy #1A2340, dark gray #333333. TYPOGRAPHY: H1 bold dark navy, teal highlight words, dark gray body. CARDS: white with light gray border or 2px shadow, teal top-accent (4px), 4-8px radius. LAYOUT: clean grid, generous whitespace. Flat icons in teal or purple. No emoji.",
  },
};
